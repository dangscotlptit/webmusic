...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <h1 class="heading">
        Welcome to webmusic! I am thrilled to have you join our music
        community. 🎉
      </h1>
      <p class="paragraph">
        With webmusic, you can access millions of songs and podcasts, create your
        own playlists, and discover new music that suits your taste. 🎧
      </p>
      <p class="paragraph">
        To get started, simply download the music app or visit our website,
...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <p class="paragraph">
        I'm sorry to hear that you're having trouble accessing your music
        account. Not to worry, though – I can help you reset your password! 🔑
      </p>
      <p class="paragraph">
        To reset your password, simply click the button below and follow the
        instructions
      </p>
      <a class="link" >Reset your password</a>
      <p class="paragraph">
